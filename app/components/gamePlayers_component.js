...
export default class GamePlayers extends Component {
  ...
  updateDataSource (detail) {
    ...
    // use Object.assign because otherwise mutating the detail.player object
  ...
  renderRow (player, _, i) {
    ...
    if (player) return (<PlayerRow player={player} key={index} last={index === detail.player.length} />)
  }
